  ...
  return(
    <Layout>
      <Seo />
        ...
        <main className="layout mt-14 p-10 rounded-2xl bg-primary-200">
          <Image 
          ...
          />
          {/* Nama_Event */}
          <Typography sizeVariant='h4' colorVariant='primary' className="font-bold mt-5">
            Save Malta Children From Hunger
          </Typography>
          <div className="flex flex-row justify-between">
            <div>
              {/* Jumlah_Donasi */}
              <Typography sizeVariant='h4' colorVariant='tertiary' className="font-bold mt-5">
                Rp. 1000000000
              </Typography>
              {/* Target_Donasi */}
            ...
            <div className="flex flex-row">
              <div className="flex flex-row justify-center gap-x-5 mx-2 min-w-[10rem] bg-primary-500 shadow-xl rounded-xl font-semibold">
          ...
          {/* Bar progress uang */}
          <div className="w-full h-2 my-10">
          ...
          <div className="bg-primary-500 p-5 rounded-xl">
            ...
            <Typography sizeVariant='c4' colorVariant='primary' className="text-justify">
          ...
          <div className="bg-primary-500 p-10 rounded-xl mt-10">
            <Typography sizeVariant='h6' colorVariant='primary' className="font-bold">
              Donasi
            </Typography>
              {listDonatur.map(({ id, name, money }) => (
                <div key={id} className="bg-primary-200 p-5 my-3 rounded-xl">
